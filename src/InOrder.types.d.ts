...
export type OrderArgs<T extends OrderTask[]> = Parameters<First<T>>;

export type OrderResult<T extends OrderTask[]> = _UWP<Parameters<First<T>>[0]>;

export type OrderChain<T extends OrderTask[]> =
