...
type _PAIR<T, V> = T extends PassThroughTask ? V : (arg : _UWP<_RET<T>>) => _RET<V>;
...
export type SeriesArgs<T extends SeriesTask[]> = _ACC<_FIRST<T>>;

export type SeriesResult<T extends SeriesTask[]> = _UWP<_RET<_LAST<T>>>;
