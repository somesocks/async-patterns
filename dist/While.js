...
var _false = (0, Promisify_1.default)(function _false(next) { return next(null, false); });
/**
* ```javascript
*
...
function While(_1, _2) {
    var conditionTask = (0, Callbackify_1.default)(_1 != null ? _1 : _false);
    var loopTask = (0, Callbackify_1.default)(_2 != null ? _2 : PassThrough_1.default);
    return (0, Promisify_1.default)((0, While_1.default)(conditionTask, loopTask));
}
