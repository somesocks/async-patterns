...
*/
declare const InSeries: <T extends import("./types").Task[]>(...tasks: SeriesChain<T>) => (...args: import("./types").Accepts<(T extends [infer V, ...infer W] ? V extends import("./PassThrough.types").PassThroughTask ? {
    ...
    brand: "5Z7RupztR4SHT30zgDbkfA";
    box: W extends [infer V, ...infer W] ? V extends import("./PassThrough.types").PassThroughTask ? any : V : W extends [infer V_1] ? V_1 : unknown;
} : V : T extends [infer V_1] ? V_1 : unknown, any>) => Promise<import("./types").PromiseResult<import("./types").Returns<(T extends [...infer W_1, infer V_2] ? V_2 extends import("./PassThrough.types").PassThroughTask ? {
    brand: "5Z7RupztR4SHT30zgDbkfA";
