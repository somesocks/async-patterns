...
export declare type OrderArgs<T extends OrderTask[]> = Parameters<First<T>>;
export declare type OrderResult<T extends OrderTask[]> = _UWP<Parameters<First<T>>[0]>;
export declare type OrderChain<T extends OrderTask[]> = T extends [infer U, ...infer V] ? [U, ..._VC<U, V>] : T;
export {};
